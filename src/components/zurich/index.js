            ...
            <div className="container">
              <a className="card" {...hide() } onClick={() => go(1)}>
                ...
                <div
                  ...
                  style={{ backgroundImage: 'url("https://raw.githubusercontent.com/brunnolou/react-morph/master/examples/demo/public/zurich.jpg")' }}
                    ...
                    {this.faces.map(({ src, username }) => (
                      <li className="users-item" key={`card-${username}`}>
                        <img
                          ...
                          src={src || "https://raw.githubusercontent.com/brunnolou/react-morph/master/examples/demo/public/brunnolou.jpg"}
                          alt={username}
                          {...from("user-" + username, {
                            zIndex: 3,
                            getMargins: false,
